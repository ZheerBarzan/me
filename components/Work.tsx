    ...
    <div className="group relative w-full bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 hover:border-red-200 dark:hover:border-red-900 hover:shadow-2xl hover:shadow-red-900/5 transition-all duration-500 flex flex-col">
        ...
        <div className="p-8 flex flex-col flex-grow">
            <div className="flex justify-between items-start mb-4">
                <h3 className="text-2xl font-bold text-zinc-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors">{name}</h3>
                {/* Github Link */}
                <a href="#" className="p-2.5 bg-zinc-50 dark:bg-zinc-800 text-zinc-400 rounded-full hover:bg-red-600 hover:text-white transition-all hover:rotate-12">
                    <Github size={18} />
                </a>
            </div>

            <p className="text-zinc-500 dark:text-zinc-400 text-sm mb-8 line-clamp-2 leading-relaxed">{description}</p>
