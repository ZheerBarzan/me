...
const SocialButton: React.FC<{
  ...
  >
    <div className="flex items-center gap-5">
      <div className="text-zinc-500 dark:text-zinc-500 group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors">
        {icon}
      </div>
      <span className="font-semibold text-zinc-700 dark:text-zinc-300 group-hover:text-zinc-900 dark:group-hover:text-white transition-colors">
        {label}
      </span>
    </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 max-w-lg text-xl mb-16 font-light">
              ...
              opportunities. Drop a line and let's create something exceptional.
            </p>
          ...
          <div className="lg:col-span-5 flex flex-col justify-center space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-zinc-500 dark:text-zinc-500 font-bold uppercase tracking-widest text-xs">
                Socials
              </h3>
            </div>
            <SocialButton
        ...
        <div className="pt-12 border-t border-zinc-100 dark:border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <span className="bg-zinc-900 dark:bg-white text-white dark:text-black w-6 h-6 flex items-center justify-center rounded text-xs font-bold">
              Z
            </span>
