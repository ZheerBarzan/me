 ...
 * Step Component
 * 
 * Represents a single step in the process workflow.
 * 
 * Props:
 * - number: string - The step number (e.g., "01.").
 * - title: string - The title of the step.
 * - description: string - A description of what happens in this step.
 */
 ...
 * Process Component
 * 
 * Displays the workflow or process followed by the engineer.
 * Includes a header section and a grid of steps.
 */
